"use strict";var g=Object.defineProperty;var y=Object.getOwnPropertyDescriptor;var j=Object.getOwnPropertyNames;var T=Object.prototype.hasOwnProperty;var S=(a,t)=>{for(var e in t)g(a,e,{get:t[e],enumerable:!0})},B=(a,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of j(t))!T.call(a,o)&&o!==e&&g(a,o,{get:()=>t[o],enumerable:!(i=y(t,o))||i.enumerable});return a};var C=a=>B(g({},"__esModule",{value:!0}),a);var H={};S(H,{activate:()=>z,deactivate:()=>F});module.exports=C(H);var x=require("path"),d=require("vscode");var h=`<!DOCTYPE html>
<!--
...
`;function f(a){for(;a.length;){let t=a.pop();t&&t.dispose()}}var p=class{_isDisposed=!1;_disposables=[];dispose(){this._isDisposed||(this._isDisposed=!0,f(this._disposables))}_register(t){return this._isDisposed?t.dispose():this._disposables.push(t),t}get isDisposed(){return this._isDisposed}};var s=require("vscode");function D(a,t){return`${a}`==`${t}`}var b=class extends p{_uri;constructor(t){super(),this._uri=t;let e=this._register(s.workspace.createFileSystemWatcher(t.fsPath)),i=o=>{D(o,t)&&this._onDidChange.fire(o)};this._register(e.onDidChange(i)),this._register(e.onDidCreate(i))}get uri(){return this._uri}_onDidDelete=this._register(new s.EventEmitter);onDidDelete=this._onDidDelete.event;_onDidChange=this._register(new s.EventEmitter);onDidChange=this._onDidChange.event;dispose(){this._onDidDelete.fire(this.uri),super.dispose()}};function m(a){return JSON.stringify(a).replace(/"/g,"&quot;")}var c=class{_webviews=new Set;*get(t){let e=t.toString();for(let i of this._webviews)i.resource===e&&(yield i.webviewPanel)}add(t,e){let i={resource:t.toString(),webviewPanel:e};this._webviews.add(i),e.onDidDispose(()=>{this._webviews.delete(i)})}};var k=h.replace('<link rel="resource" type="application/l10n" href="locale/locale.json">',"").replace('<script src="../build/pdf.mjs" type="module"></script>',"").replace('<script src="viewer.mjs" type="module"></script>',"").replace('<link rel="stylesheet" href="viewer.css">',""),L="https://file+.vscode-resource.vscode-cdn.net",A=/\/[^/]+?\.\w+$/,u=class a{static viewType="pdf.view";static register(t){return d.window.registerCustomEditorProvider(a.viewType,new a(t),{supportsMultipleEditorsPerDocument:!1})}webviews=new c;extensionRoot;constructor(t){this.extensionRoot=d.Uri.file(t.extensionPath)}openCustomDocument(t){let e=new b(t),i=[],r=null;return i.push(e.onDidChange(o=>{r&&clearTimeout(r),r=setTimeout(()=>{for(let n of Array.from(this.webviews.get(o))){let l=n.viewColumn;n.dispose(),setTimeout(()=>{d.commands.executeCommand("vscode.openWith",o,a.viewType,{viewColumn:l,preserveFocus:!0,preview:!1})},80)}},1800)})),e.onDidDelete(()=>{r&&clearTimeout(r),f(i)}),e}UriResolver(t){return(...e)=>t.asWebviewUri(d.Uri.file((0,x.join)(this.extensionRoot.path,...e)))}resolveCustomEditor(t,e){this.webviews.add(t.uri,e);let i=t.uri.with({path:t.uri.path.replace(A,"/")});e.webview.options={enableScripts:!0,retainContextWhenHidden:!0,localResourceRoots:[i,this.extensionRoot]},e.webview.html=this.getHtmlForWebview(t,e.webview),e.webview.onDidReceiveMessage(o=>{if("open"in o){let n=o.open,[l="",r]=n.substring(L.length).split("#");d.commands.executeCommand("vscode.open",d.Uri.file(l).with({fragment:r??""}))}})}getHtmlForWebview(t,e){let i=this.UriResolver(e),o=(...v)=>i("assets",...v),n=(...v)=>i("assets","pdf.js",...v),l=e.cspSource,r=d.workspace.getConfiguration("pdf"),w={url:`${e.asWebviewUri(t.uri)}`,docBaseUrl:`${e.asWebviewUri(t.uri)}`,defaultZoomValue:r.get("defaultZoomValue","auto"),sidebarViewOnLoad:r.get("sidebarViewOnLoad",0)};return k.replace("<title>PDF.js viewer</title>",`
<meta http-equiv="Content-Security-Policy" content="default-src 'none'; connect-src ${l}; script-src 'unsafe-inline' ${l}; worker-src blob: ${l}; style-src 'unsafe-inline' ${l}; img-src * ${l} data:;">
<meta id="pdf-view-config" data-config="${m(w)}">

<title>PDF.js viewer</title>

<link rel="stylesheet" href="${n("web","viewer.css")}">
<link rel="stylesheet" href="${o("main.css")}">

<script src="${n("build","pdf.mjs")}" type="module"></script>
<script src="${o("main.mjs")}" type="module"></script>

<link rel="resource" type="application/l10n" href="${n("web","locale","locale.json")}">`).trim()}};function z(a){a.subscriptions.push(u.register(a))}function F(){}0&&(module.exports={activate,deactivate});
